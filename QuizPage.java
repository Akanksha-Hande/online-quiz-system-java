...
public class QuizPage extends JFrame implements ActionListener{
    ...
    QuizPage(String username){
       ...
       i1 = new ImageIcon(getClass().getResource("Rem2.png"));
        JLabel l1 = new JLabel(i1);
       l1.setBounds(0, 0, 1100, 600);
        //add(l1);
        ...
        opt1.setBounds(170, 210, 700, 30);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt1.setBackground(Color.WHITE);
        add(opt1);
        
        opt2 = new JRadioButton("");
        opt2.setBounds(170, 250, 700, 30);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt2.setBackground(Color.WHITE);
        add(opt2);
        
        opt3 = new JRadioButton("");
        opt3.setBounds(170, 290, 700, 30);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt3.setBackground(Color.WHITE);
        add(opt3);
        
        opt4 = new JRadioButton("");
        opt4.setBounds(170, 330, 700, 30);
        ...
        next.setBounds(300, 420, 200, 50);
        add(next);
        
        lifeline = new JButton("BookMark");
        lifeline.setFont(new Font("Tahoma", Font.PLAIN, 22));
        lifeline.setBackground(new Color(30, 144, 255));
        lifeline.setForeground(Color.WHITE);
        lifeline.setBounds(550, 420, 200, 50);
        ...
        submit.setBounds(420, 490, 200, 50);
        add(submit);
